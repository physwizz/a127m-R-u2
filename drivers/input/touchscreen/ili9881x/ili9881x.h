...
do {									\
	if (debug_en)						\
	pr_info("[sec_input]: (%s, %d): " fmt, __func__, __LINE__, ##arg);	\
} while (0)
...
enum SET_CURRENT_MODE {
	SET_MODE_NORMAL = 0,
	SET_MODE_PROXIMTY_LCDOFF = 1,
	SET_MODE_GESTURE = 2,
};
...
#define ALPHABET_LINE_2_TOP				(OFF)//BIT1
#define ALPHABET_LINE_2_BOTTOM				(OFF)//BIT2
#define ALPHABET_LINE_2_LEFT				(OFF)//BIT3
...
#define ALPHABET_V_DOWN					(OFF)//BIT13
#define ALPHABET_V_LEFT					(OFF)//BIT14
#define ALPHABET_V_RIGHT				(OFF)//BIT15
#define ALPHABET_TWO_LINE_2_BOTTOM			(OFF)//BIT16
#define ALPHABET_F					(OFF)//BIT17
#define ALPHABET_AT					(OFF)//BIT18

#define DOUBLE_TAP_MASK					0xfffffe//BIT0
#define ALPHABET_LINE_2_TOP_MASK			0xfffffd//BIT1
#define ALPHABET_LINE_2_BOTTOM_MASK			0xfffffb//BIT2
#define ALPHABET_LINE_2_LEFT_MASK			0xfffff7//BIT3
#define ALPHABET_LINE_2_RIGHT_MASK			0xffffef//BIT4
#define ALPHABET_M_MASK					0xffffdf//BIT5
#define ALPHABET_W_MASK					0xffffbf//BIT6
#define ALPHABET_C_MASK					0xffff7f//BIT7
#define ALPHABET_E_MASK					0xfffeff//BIT8
#define ALPHABET_V_MASK					0xfffdff//BIT9
#define ALPHABET_O_MASK					0xfffbff//BIT10
#define ALPHABET_S_MASK					0xfff7ff//BIT11
#define ALPHABET_Z_MASK					0xffefff//BIT12
#define ALPHABET_V_DOWN_MASK				0xffdfff//BIT13
#define ALPHABET_V_LEFT_MASK				0xffbfff//BIT14
#define ALPHABET_V_RIGHT_MASK				0xff7fff//BIT15
#define ALPHABET_TWO_LINE_2_BOTTOM_MASK			0xfeffff//BIT16
#define ALPHABET_F_MASK					0xfdffff//BIT17
#define ALPHABET_AT_MASK				0xfbffff//BIT18
...
struct ilitek_ts_data {
	...
	const char *regulator_lcd_rst;
	struct regulator *lcd_rst;
...
/*  add_for_charger_end  */
	...
	struct ilitek_coordinate coord[MAX_TOUCH_NUM];
	int touch_count;
...
extern void ili_fw_read_flash_info(void);
...
#if AXIS_PACKET
extern void ili_touch_press(u16 x, u16 y, u16 pressure, u16 id, u16 width_major, u16 width_minor);
#else
extern void ili_touch_press(u16 x, u16 y, u16 pressure, u16 id);
#endif
#if AXIS_PACKET
extern void ili_touch_release(u16 x, u16 y, u16 id, u16 width_major, u16 width_minor);
#else
...
extern void ili_ic_set_ddi_reg_onepage(u8 page, u8 reg, u8 data);
extern void ili_ic_get_ddi_reg_onepage(u8 page, u8 reg, u8 *data);
extern int ili_ic_whole_reset(void);
extern int ili_ic_code_reset(void);
...
extern void ilitek_pin_control(bool pin_set);
...
extern void ili_irq_wake_enable(void);
extern void ili_irq_wake_disable(void);
